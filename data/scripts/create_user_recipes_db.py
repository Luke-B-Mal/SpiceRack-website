...
rows = [
    ("Marinated Flank Steak Recipe", "Dinner"),
    ("French Chicken Stew", "Dinner"),
    ("My Favorite Cheese Cake", "Snack/Dessert"),
    ("Pork rub", "Other/General")
    ]

cursor.executemany("INSERT INTO recipes (title, category) VALUES (?, ?)", rows)
